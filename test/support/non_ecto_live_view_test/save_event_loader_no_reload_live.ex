defmodule Permit.NonEctoLiveViewTest.SaveEventLoaderNoReloadLive do
  @moduledoc """
  ...
  def loader(%{params: %{"id" => id}, socket: socket}) do
    ...
    |> then(fn found_item ->
      ...
      # concurrently. In this case, the loader should be coded to return the updated item,
      # but the test should ensure that the loader is NOT called.
