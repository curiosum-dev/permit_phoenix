defmodule Permit.NonEctoLiveViewTest.EndpointOverridable do
  @moduledoc false
  defmacro __before_compile__(_env) do
    quote do
      alias Permit.NonEctoLiveViewTest.LiveRouter
...
defmodule Permit.NonEctoLiveViewTest.Endpoint do
  use Phoenix.Endpoint, otp_app: :phoenix_live_view

  @before_compile Permit.NonEctoLiveViewTest.EndpointOverridable
